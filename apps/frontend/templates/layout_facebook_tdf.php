...
<script type="text/javascript">
            ...
            window.fbAsyncInit = function() {
                FB.init({
                  appId      : '<?php echo sfConfig::get('mod_facebook_tdf_facebook_connect_app_id') ?>',
                  status     : true, 
                  cookie     : true,
...
<body>
	...
	<script type="text/javascript">
			...
			var _gaq = _gaq || [];
            _gaq.push(['_setAccount', "<?php echo sfConfig::get('mod_facebook_tdf_analytics_google') ?>"]);
    ...
    <?php include_component("facebook_tdf", "header")?>
	<?php echo $sf_content ?>
	<?php include_component("facebook_tdf", "footer")?> 
	</div>
</body>
</html>
