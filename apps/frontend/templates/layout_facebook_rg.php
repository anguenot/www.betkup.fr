...
<script type="text/javascript">
        	...
        	if (typeof FB == 'undefined') {   	
	            window.fbAsyncInit = function() {
	                FB.init({
	                  appId      : '<?php echo sfConfig::get('mod_facebook_rg_facebook_connect_app_id') ?>',
	                  status     : true, 
	                  cookie     : true,
	                  xfbml      : true
	                });
...
<body>
	...
	<script type="text/javascript">
			...
			var _gaq = _gaq || [];
            _gaq.push(['_setAccount', "<?php echo sfConfig::get('mod_facebook_rg_analytics_google') ?>"]);
	...
	<?php include_component("facebook_rg", "header")?>
	<?php echo $sf_content ?>
	<?php include_component("facebook_rg", "footer")?>
	</div>
</body>
</html>
