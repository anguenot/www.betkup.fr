	...
	<table style="border-spacing: 0;">
		...
		<tr>
			<td align="left" valign="top">
				<div id="masqueClassement" style="position: relative; width: <?php echo $LARG ?>px; height:<?php echo $HAUT ?>px; overflow:hidden;">
					<div id="bandeClassement"
						style="position: relative; left: 0px; top: 0px;">
						<table style="border-spacing: 0;" id="tabClassement">
							<tr>
								<td><?php foreach ($rankingData as $data): ?>
									<div class="row">
				...
				<table style="border-spacing: 0;">
					<tr>
						<td height="69" align="left" valign="top"><a
							...
							id="kupHomeLeftButton"> <img src="/images/home/boutonTop.png"
								border="0"> </a>
						</td>
					</tr>
					<tr>
						<td height="69" align="left" valign="bottom"><a
							...
							id="kupHomeLeftButton"> <img src="/images/home/boutonBottom.png"
								border="0"> </a>
						</td>
					</tr>
				</table>
