    ...
    <table style="border-spacing: 0;">
		...
		<tr>
            <td align="left" valign="top">
                <div id="masqueNews" style="position: relative; width: <?php echo $LARG ?>px; height:<?php echo $HAUT ?>px; overflow:hidden;">
                    <div id="bandeNews" style="position: relative; left: 0px; top: 0px;">
