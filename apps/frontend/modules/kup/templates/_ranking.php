...
<form action="" method="post" name="frmClassementList" class="frmClassementList">
    ...
    <table style="width:710px;">
        ...
        <tr class="<?php echo (($kupRankingData['position'] % 2) ? 'pair' : 'impair') . ($sf_user->getAttribute('email', '', 'subscriber') == $kupRankingData['member']['email'] ? ' selected' : '') ?>">
            ...
            <?php endif ?>
            <!-- td><?php echo image_tag('kup/classement/equal.png', array(
                                                                          'alt'  => '',
                                                                          'size' => '29x50'
                                                                     )) ?></td-->
            <td class="prediction-date">
                <?php if ($kupData['status'] == -1 || $kupData['status'] >= 3): ?>
                <?php echo util::displayDateCompleteFromTimestampComplet($kupRankingData['firstPrediction']) ?>
                <?php else: ?>
                -
                <?php endif;?>
            </td>
            <td class="num">
                ...
                <?php if ($kupData['status'] == 5 && $sf_user->getAttribute('email', '', 'subscriber') == $kupRankingData['member']['email']) : ?>
                    <a href="javascript:void(0);" class="publish_jackpot" onclick="rankingPublishFacebook()">
    ...
    <div class="tabClassementBottom">
        ...
        <?php echo link_to(__('kup_ranking_link_go_to_ranking_label'), array(
                                                                            'module' => 'kup',
                                                                            'action' => 'ranking',
                                                                            'uuid'   => $uuid,
                                                                            'offset' => $offsetMemberRanking
                                                                       )) ?>
        <?php endif ?>
    </div>
    <div class="tabClassementBottomPage">
        <div style="margin-top: 10px;">
            ...
            <?php if (!isset($room_uuid)): ?>
                <?php if ($supToMiddle == '1' || $supToLast == '1' || ($nbPageRemaining != $nbPage)): ?>
                    <?php echo link_to(image_tag('kup/classement/pageFirst.png', array(
                                                                                      'alt'  => '',
                                                                                      'size' => '19x19'
                                                                                 )), array(
                                                                                          'module' => 'kup',
                ...
                <a href="<?php echo url_for(array(
                                                 ...
                                                 'uuid'   => $uuid,
                                                 'offset' => intval($offset) - intval($batch)
                                            )) ?>" title=""><?php echo image_tag('kup/classement/pageBack.png', array(
                                                                                                                     'alt'  => '',
                                                                                                                     'size' => '19x19'
                                                                                                                )) ?></a>
                <?php else: ?>
                <?php if ($supToMiddle == '1' || $supToLast == '1' || ($nbPageRemaining != $nbPage)): ?>
                    ...
                    <?php endif; ?>
                <a href="<?php echo url_for(array(
                                                 'module'   => 'room', 'action'=> 'kupRanking',
                                                 'kup_uuid' => $uuid, 'room_uuid' => $room_uuid,
                                                 'tab'      => 'ranking',
                                                 'offset'   => intval($offset) - intval($batch)
                                            )) ?>" title=""><?php echo image_tag('kup/classement/pageBack.png', array(
                                                                                                                     'alt'  => '',
            ...
            <?php for ($i = 1; $i <= $nbPage; $i++): ?>
                <?php if ($i <= ($numActualPage + 2)): ?>
                    <?php if (!isset($room_uuid)): ?>
                        ...
                        <?php echo button_to($i, array(
                                                      ...
                                                      'action'    => 'kupRanking',
                                                      'kup_uuid'  => $uuid,
                                                      'room_uuid' => $room_uuid, 'tab' => 'ranking',
                                                      'offset'    => ($batch * ($i - 1))
                                                 ), array('class'=> 'paginate')) ?>
                        <?php endif ?>
                    <?php endif; ?>
                <?php endfor; ?>
            <?php if (!($nbPage <= '3')): ?>
                <?php echo image_tag('kup/classement/pagePoints.png', array(
                                                                           'alt'  => '',
                                                                           'size' => '19x19'
                                                                      )); ?>
                <?php endif; ?>
            ...
            <?php if (!isset($room_uuid)): ?>
                ...
                <?php echo button_to(($numActualPage - 2), array(
                                                                'module' => 'kup',
                                                                'action' => 'ranking',
                                                                'uuid'   => $uuid,
                                                                'offset' => ($batch * ($numActualPage - 3))
                                                           ), array('class'=> 'paginate')) ?>
                <?php echo button_to(($numActualPage - 1), array(
                                                                'module' => 'kup',
                                                                'action' => 'ranking',
                                                                'uuid'   => $uuid,
                                                                'offset' => ($batch * ($numActualPage - 2))
                                                           ), array('class'=> 'paginate')) ?>
                <?php echo button_to($numActualPage, array(
                                                          'module' => 'kup', 'action'=> 'ranking',
                                                          'uuid'   => $uuid,
                                                          'offset' => ($batch * ($numActualPage - 1))
                                                     ), array('class'=> 'paginate')) ?>
                <?php echo button_to(($numActualPage + 1), array(
                                                                'module' => 'kup',
                                                                'action' => 'ranking',
                                                                'uuid'   => $uuid,
                                                                'offset' => ($batch * ($numActualPage))
                                                           ), array('class'=> 'paginate')) ?>
                <?php echo button_to(($numActualPage + 2), array(
                                                                'module' => 'kup',
                                                                'action' => 'ranking',
        ...
        elseif ($supToLast == '1'): ?>
            <?php if (!isset($room_uuid)): ?>
                <?php if (!($nbPage <= '3')) {
                    echo image_tag('kup/classement/pagePoints.png', array(
                                                                         'alt'  => '',
                                                                         'size' => '19x19'
                                                                    ));
                } ?>
            ...
            <?php if (!isset($room_uuid)): ?>
                <?php if ($nbPageRemaining != '0'): ?>
                    <a href="<?php echo url_for(array(
                                                     ...
                                                     'uuid'   => $uuid,
                                                     'offset' => intval($offset) + intval($batch)
                                                )) ?>" title=""><?php echo image_tag('kup/classement/pageNext.png', array(
                                                                                                                         'alt'  => '',
                                                                                                                         'size' => '19x19'
                                                                                                                    )) ?></a>
                    <?php endif; ?>
                <?php if ($supToMiddle == '1' || $supToFirst == '1' || $nbPageRemaining != '0'): ?>
                    <?php echo link_to(image_tag('kup/classement/pageLast.png', array(
                                                                                     'alt'  => '',
                                                                                     'size' => '19x19',
...
<script type="text/javascript">
    ...
    function rankingPublishFacebook() {
