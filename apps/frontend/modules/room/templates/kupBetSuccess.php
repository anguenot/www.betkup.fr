        	...
        	<tr>
				...
				<td style="vertical-align: top; width: 220px;">
					<div style="padding-left: 5px; padding-top: 7px;">
						<?php if (isset($roomUI)): ?>
						<?php include_component('kup', 'right', array('kupData' => $kupData, 'roomUI' => $roomUI, 'room_uuid' =>$room_uuid)) ?>
						<?php else: ?>
						<?php include_component('kup', 'right', array('kupData' => $kupData, 'room_uuid' =>$room_uuid)) ?>
						<?php endif ?>
					</div>
				</td>
			</tr>
