        	...
        	<tr>
            	<td style="vertical-align: top; width: 760px;">
					<div class="view" style="margin-top: 4px; width: 760px;">
						<div style="margin: 0px; margin-left: 5px; margin-bottom: 10px;">
						...
						<?php include_component('interface', 'areaOneBegin', array('displayTop' => false, 'marginleft' => '20')) ?>
						<div>
						<?php include_component('room', 'kupRanking',
							array(
							'uuid' => $kup_uuid,
							'room_uuid' => $room_uuid,
					    ...
					    <div class="fb-comments" data-href="<?php echo $urlForFacebook; ?>" data-num-posts="5" data-width="730"></div>
