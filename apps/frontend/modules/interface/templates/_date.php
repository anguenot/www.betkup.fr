<div id="<?php echo $blocName ?>_bulle" style="z-index: 100; position: absolute; margin-top: -15px; margin-left: <?php echo $marginLeftError ?>px; width: 229px; height: 66px; background: url('/images/interface/bulle.png') center no-repeat; display: none; ">
        ...
        <tr>
            ...
            <td width="<?php echo $width2 ?>" align="right" height="28" valign="middle">
                <table style="margin-left: 10px;">
                    <tr>
                        <td width="80px" id="<?php echo $blocName ?>_1_td">
                            <select id="<?php echo $blocName ?>_1" name="<?php echo $bloc ?>[<?php echo $blocName ?>_1]" class="formInputSelect">
                            <?php foreach ( $blocChoices1 as $key => $choice ): ?>
                                <option value="<?php echo $choice ?>" <?php echo ($choice==$blocValue1?'selected':'') ?>><?php echo $choice ?></option>
                            <?php endforeach ?>
                            </select>
                        </td>
                        <td width="80px" id="<?php echo $blocName ?>_2_td">
                            ...
                            <?php foreach ( $blocChoices2 as $key => $choice ): ?>
                        ...
                        <td width="80px" id="<?php echo $blocName ?>_3_td">
                            ...
                            <?php foreach ( $blocChoices3 as $key => $choice ): ?>
...
<?php if (isset($blocHelp)): ?>
 <script type="text/javascript">
<?php for ($i = 1; $i < 4; $i++) { ?>
$("#<?php echo $blocName.'_'.$i; ?>_td").live('focusin mouseover', function() {
