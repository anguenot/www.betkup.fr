        ...
        <tr>
            ...
            <td width="500" align="left" height="28" valign="middle">
                <div id="<?php echo $blocName ?>_input" style="margin-left: 10px;">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><div class="legende ibanLegende">&nbsp; <?php echo __('IBAN') ?></div></td>
                            <td><div class="legende ibanLegende">&nbsp; <?php echo __('BIC/SWIFT') ?></div></td>
                        </tr>
                        <tr>
                            <td><input type="text" id="<?php echo $blocName ?>_1" name="<?php echo $bloc ?>[<?php echo $blocName ?>_1]" value="<?php echo $blocValue[0] ?>" class="formInputVarchar3 iban"></td>
                            <td><input type="text" id="<?php echo $blocName ?>_2" name="<?php echo $bloc ?>[<?php echo $blocName ?>_2]" value="<?php echo $blocValue[1] ?>" class="formInputVarchar3 iban"></td>
                        </tr>
                    </table>
