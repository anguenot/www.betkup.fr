	...
	<table style="width: 670px; border-collapse: collapse; border-spacing: 0px;">
		<tr>
			...
			<td style="vertical-align: top; padding-top: 40px; font-family: Verdana; font-size: 12px; color: #6A6A69;">
				<?php echo __('text_challenge_home_welcome_description_tdf_2012', array('%br%' => '<br />', '%b%' => '<b>', '%/b%' => '</b>', '%author%' => $dataRoom['author_nickname'], '%name%' => $dataRoom['name']))?>
			</td>
		</tr>
	</table>
</div>
...
<div id="challenge-view-container">
	...
	<p>
		Pronostique tout les jours sur les étapes du jour, et partage la somme promise aux vainqueurs chaque journées.
	</p>
	<p>
		Ce faisant tu marques des points et prends automatiquement part au Challenge Tour de France. Les 3 premiers à la fin de la compétition se partageront le jackpot de 400€.
	</p>
		...
		<tbody>
			...
			<tr>
				<td>
					<div class="challenge-tree-bloc">
						<h4>2</h4>
						<p>Je termine dans les places payées pour partager la cagnotte du jour (2800 euros sur le Tour)</p>
					</div>
				</td>
