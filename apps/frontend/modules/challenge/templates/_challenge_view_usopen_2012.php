    ...
    <table style="width: 670px; border-collapse: collapse; border-spacing: 0px;">
        <tr>
            ...
            <td style="vertical-align: top; padding-top: 40px; font-family: Verdana; font-size: 12px; color: #6A6A69;">
                Bienvenue sur le Challenge "Kup du Jour US Open". C'est le retour du Tennis sur Betkup. Tu penses être le meilleur pronostiqueur Betkup sur les Grands Chelems ?
                <br/><br/>
                Viens relever le Challenge sur les Kups du Jour ! Si tu gagnes tu sera couvert d'or (enfin d'euros) si tu perds tu sera jeté aux crocodiles, mais vu qu'on à pas de crocos chez Betkup à la place t'auras juste pas d'or..
            </td>
        </tr>
    </table>
</div>
...
<div id="challenge-view-container">
    ...
    <p>
        Pronostique tout les jours sur les Kups du Jour US Open, et partage la somme promise aux vainqueurs chaque journées.
    </p>

    <p>
        Ce faisant tu marques des points et prends automatiquement part au Challenge KDJ US Open. Les 3 premiers à la fin de la compétition se partageront le jackpot de 300€.
    </p>
        ...
        <tr>
            <td colspan="3">
                <div class="challenge-tree-bloc">
                    ...
                    <p>Je pronostique sur la Kup du jour US Open</p>
                </div>
        ...
        <tr>
            <td>
                <div class="challenge-tree-bloc">
                    ...
                    <p>Je termine dans les places payées pour partager la cagnotte du jour (1320 euros sur l'US Open)</p>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="challenge-tree-bloc">
                    ...
                    <p>Je partage les 300€ de cagnotte si je termine dans les 3 premiers</p>
                </div>
