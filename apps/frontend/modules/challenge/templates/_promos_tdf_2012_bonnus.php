...
<div id="promo-description">
	<p>
	<?php echo __('text_promo_tdf_2012_introduction', array('%br%' => '<br />', '%important%' => '<span class="important">', '%/important%' => '</span>'))?>
	</p>
...
<div id="promo-warning">
	...
	<p>
	<?php echo __('text_promo_tdf_2012_rules', array('%br%' => '<br />', '%b%' => '<b>', '%/b%' => '</b>'))?>
	</p>
	</div>
</div>
