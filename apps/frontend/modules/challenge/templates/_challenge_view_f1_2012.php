    ...
    <table style="width: 670px; border-collapse: collapse; border-spacing: 0px;">
        <tr>
            ...
            <td style="vertical-align: top; padding-top: 40px; font-family: Verdana; font-size: 12px; color: #6A6A69;">
                <?php echo __('text_challenge_home_welcome_description_f1_2012', array(
                                                                                      '%br%'     => '<br />',
                                                                                      '%b%'      => '<b>',
                                                                                      '%/b%'     => '</b>',
...
<h2 id="challenge-elite">
    Relève le défi sur le championnat et rentre dans la légende Betkup !
</h2>
<div style="height: 10px;"></div>
<div id="challenge-view-container">
    ...
    <p>
        Pronostique sur tout les Kups F1, et partage la somme promise aux vainqueurs chaque
        journées.
    </p>

    <p>
        Ce faisant tu marques des points et prends automatiquement part au Challenge Kups F1. Les 3
        premiers à la fin de la compétition se partageront le jackpot de 420€.
    </p>
        ...
        <tr>
            <td colspan="3">
                <div class="challenge-tree-bloc">
                    ...
                    <p>Je pronostique sur la Kup F1</p>
                </div>
        ...
        <tr>
            <td>
                <div class="challenge-tree-bloc">
                    ...
                    <p>Je termine dans les places payées pour partager la cagnotte du jour (1080
                        euros sur les GP restants)</p>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="challenge-tree-bloc">
                    ...
                    <p>Je partage les 420€ de cagnotte si je termine dans les 3 premiers</p>
                </div>
    ...
    <a href="<?php echo url_for(array(
                                     ...
                                     'selectedDatas' => array(
                                         'SPORTS_F1', 'STAKE_FREEROLLS', 'STAKE_PAYABLE', 'status_IN_PROGRESS',
