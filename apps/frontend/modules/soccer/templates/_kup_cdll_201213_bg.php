<div class="regle">
    <div style="margin-left: 10px; margin-top: 20px; width: 670px;">
        ...
        Array('orange' => '','legende' => 'Il y aura il plus de 2 buts inscrits durant ce match (prolongations incluses) ?','image' => '/images/kup/view/regle/tabFlecheVerte.png','score' => '5'),
        Array('orange' => '','legende' => 'Combien de buts seront inscrits au cours des 120 minutes ?','image' => '/images/kup/view/regle/tabFlecheVerte.png','score' => '15'),
